    ...
    for valid_theta_err in valid_theta_errs:
        ...
        for kk in range(len(subpop_inds)):
            ...
            for rand_seed in rand_seeds:
                ...
                # print("Process Subpop {} Error {} Rand Seed {} Target Model {}".format(subpop_ind,valid_theta_err,rand_seed,target_gen_proc))
                # create the valid path
                path_name = 'files/tables/{}/{}/{}/{}/{}'.format(dataset_name,args.model_type, subpop_type,target_gen_proc,repeat_num)
                if not os.path.isdir(path_name):
                    os.makedirs(path_name)

                # only produce results for the actual target classifier
                if poison_whole:
                    filename = 'files/online_models/{}/{}/{}/{}/{}/{}/whole-{}_online_for_real_data_tol-{}_err-{}.npz'.format(dataset_name,args.model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                else:
                    filename = 'files/online_models/{}/{}/{}/{}/{}/{}/subpop-{}_online_for_real_data_tol-{}_err-{}.npz'.format(dataset_name,args.model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                ...
                if poison_whole:
                    filename = 'files/kkt_models/{}/{}/{}/{}/{}/{}/whole-{}_kkt_frac_info_tol-{}_err-{}.npz'.format(dataset_name,args.model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                else:
                    filename = 'files/kkt_models/{}/{}/{}/{}/{}/{}/subpop-{}_kkt_frac_info_tol-{}_err-{}.npz'.format(dataset_name,args.model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                data_info = np.load(filename)
