    ...
    for rand_seed in rand_seeds:
        for valid_theta_err in valid_theta_errs:
            ...
            for kk in range(len(subpop_inds)):
                ...
                print("Process ID {} Subpop {} Error {} Rand Seed {} Target Model {}".format(sub_id,subpop_ind,valid_theta_err,rand_seed,target_gen_proc))
                # create the valid path
                path_name = 'files/final_results/{}/{}/{}/{}/{}/{}'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num)
                ...
                if baseline_only:
                    ...
                    for ratio_used_in_target in ratios:
                        ...
                        # if poison_whole:
                        #     filename = 'files/online_models/{}/{}/{}/{}/{}/whole-{}_online_for_baseline_data_tol-{}_err-{}.npz'.format(dataset_name,model_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                        # else:
                        #     filename = 'files/online_models/{}/{}/{}/{}/{}/subpop-{}_online_for_baseline_data_tol-{}_err-{}.npz'.format(dataset_name,model_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)

                        if poison_whole:
                            filename = 'files/online_models/{}/{}/{}/{}/{}/{}/whole-{}_online_for_baseline_data_tol-{}_err-{}_ratio-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err,ratio_used_in_target)
                        else:
                            filename = 'files/online_models/{}/{}/{}/{}/{}/{}/subpop-{}_online_for_baseline_data_tol-{}_err-{}_ratio-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err,ratio_used_in_target)
                        ...
                        if poison_whole:
                            filename = 'files/kkt_models/{}/{}/{}/{}/{}/{}/whole-{}_baseline_attack_tol-{}_err-{}_ratio-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err,ratio_used_in_target)
                        else:
                            filename = 'files/kkt_models/{}/{}/{}/{}/{}/{}/subpop-{}_baseline_attack_tol-{}_err-{}_ratio-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err,ratio_used_in_target)
                        # if poison_whole:
                        #     filename = 'files/kkt_models/{}/{}/{}/{}/{}/whole-{}_baseline_attack_tol-{}_err-{}.npz'.format(dataset_name,model_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                        # else:
                        #     filename = 'files/kkt_models/{}/{}/{}/{}/{}/subpop-{}_baseline_attack_tol-{}_err-{}.npz'.format(dataset_name,model_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                        data_info = np.load(filename)
                        ...
                        if poison_whole:
                            filename = 'files/final_results/{}/{}/{}/{}/{}/{}/baseline_whole-{}_acc_score_tol-{}_err-{}_ratio-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err,ratio_used_in_target)
                        else:
                            filename = 'files/final_results/{}/{}/{}/{}/{}/{}/baseline_subpop-{}_acc_score_tol-{}_err-{}_ratio-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err,ratio_used_in_target)
                ...
                if poison_whole:
                    filename = 'files/online_models/{}/{}/{}/{}/{}/{}/whole-{}_online_for_real_data_tol-{}_err-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                else:
                    filename = 'files/online_models/{}/{}/{}/{}/{}/{}/subpop-{}_online_for_real_data_tol-{}_err-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                data_info = np.load(filename)
                online_acc_scores = data_info["online_acc_scores"]
                # plot the test acc on the subpopulation, max loss diff, norm diff
                online_acc_score = online_acc_scores[4]
                ...
                if args.model_type != 'lr':
                    ...
                    if poison_whole:
                        filename = 'files/online_models/{}/{}/{}/{}/{}/{}/whole-{}_online_for_online_data_tol-{}_err-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                    else:
                        filename = 'files/online_models/{}/{}/{}/{}/{}/{}/subpop-{}_online_for_online_data_tol-{}_err-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                    data_info1 = np.load(filename)
                    lower_bounds_ol = data_info1["lower_bounds"]

                    if poison_whole:
                        filename = 'files/online_models/{}/{}/{}/{}/{}/{}/whole-{}_online_for_kkt_data_tol-{}_err-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                    else:
                        filename = 'files/online_models/{}/{}/{}/{}/{}/{}/subpop-{}_online_for_kkt_data_tol-{}_err-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                    data_info2 = np.load(filename)
                    lower_bounds_kkt = data_info2["lower_bounds"]

                # load the kkt fraction info
                if poison_whole:
                    filename = 'files/kkt_models/{}/{}/{}/{}/{}/{}/whole-{}_kkt_frac_info_tol-{}_err-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                else:
                    filename = 'files/kkt_models/{}/{}/{}/{}/{}/{}/subpop-{}_kkt_frac_info_tol-{}_err-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                data_info = np.load(filename)
                ...
                if poison_whole:
                    filename = 'files/final_results/{}/{}/{}/{}/{}/{}/whole-{}_acc_score_tol-{}_err-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err)
                else:
                    filename = 'files/final_results/{}/{}/{}/{}/{}/{}/subpop-{}_acc_score_tol-{}_err-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err)
                ...
                if args.model_type != 'lr':
                    ...
                    if poison_whole:
                        filename = 'files/final_results/{}/{}/{}/{}/{}/{}/whole-{}_lower_bounds_online_tol-{}_err-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err)
                    else:
                        filename = 'files/final_results/{}/{}/{}/{}/{}/{}/subpop-{}_lower_bound_online_tol-{}_err-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err)
                    ...
                    if poison_whole:
                        filename = 'files/final_results/{}/{}/{}/{}/{}/{}/whole-{}_lower_bounds_kkt_tol-{}_err-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err)
                    else:
                        filename = 'files/final_results/{}/{}/{}/{}/{}/{}/subpop-{}_lower_bound_kkt_tol-{}_err-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err)
                ...
                if poison_whole:
                    filename = 'files/final_results/{}/{}/{}/{}/{}/{}/whole-{}_max_loss_diff_tol-{}_err-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err)
                else:
                    filename = 'files/final_results/{}/{}/{}/{}/{}/{}/subpop-{}_max_loss_diff_tol-{}_err-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err)
                ...
                if poison_whole:
                    filename = 'files/final_results/{}/{}/{}/{}/{}/{}/whole-{}_norm_diff_tol-{}_err-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err)
                else:
                    filename = 'files/final_results/{}/{}/{}/{}/{}/{}/subpop-{}_norm_diff_tol-{}_err-{}.png'.format(dataset_name,model_type, subpop_type,rand_seed,target_gen_proc,repeat_num,sub_id,incre_tol_par,valid_theta_err)
                ...
                if args.dataset == 'mnist_17' and target_gen_proc == 'orig' and args.model_type == 'svm':
                    ...
                    if poison_whole:
                        filename = 'files/online_models/{}/{}/{}/{}/{}/{}/whole-{}_online_for_compare_data_tol-{}_err-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,'improved',repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                    else:
                        filename = 'files/online_models/{}/{}/{}/{}/{}/{}/subpop-{}_online_for_compare_data_tol-{}_err-{}.npz'.format(dataset_name,model_type, subpop_type,rand_seed,'improved',repeat_num,subpop_ind,incre_tol_par,valid_theta_err)
                    data_info = np.load(filename)
                    online_acc_scores = data_info["online_acc_scores"]
                    # plot the test acc on the subpopulation, max loss diff, norm diff
                    online_acc_score = online_acc_scores[4]
                    ...
                    if poison_whole:
                        filename = 'files/final_results/{}/{}/{}/{}/{}/{}/whole-{}_acc_score_tol-{}_err-{}_compare.png'.format(dataset_name,model_type, subpop_type,rand_seed,'improved',repeat_num,sub_id,incre_tol_par,valid_theta_err)
                    else:
                        filename = 'files/final_results/{}/{}/{}/{}/{}/{}/subpop-{}_acc_score_tol-{}_err-{}_compare.png'.format(dataset_name,model_type, subpop_type,rand_seed,'improved',repeat_num,sub_id,incre_tol_par,valid_theta_err)
