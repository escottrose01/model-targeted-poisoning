...
from utils_for_mixed_clusters import *
...
for valid_theta_err in valid_theta_errs:
    ...
    for kk in [0,1,2,3,4]:
        ...
        if args.target_model == "real" or args.target_model == "all":
            ...
            if args.poison_whole:
                filename = 'files/online_models/{}/{}/{}/{}/{}/whole-{}_online_for_real_model_tol-{}_err-{}.sav'.format(dataset_name,args.model_type,args.rand_seed,target_gen_proc,args.repeat_num,subpop_ind,args.incre_tol_par,valid_theta_err)
            else:
                filename = 'files/online_models/{}/{}/{}/{}/{}/subpop-{}_online_for_real_model_tol-{}_err-{}.sav'.format(dataset_name,args.model_type,args.rand_seed,target_gen_proc,args.repeat_num,subpop_ind,args.incre_tol_par,valid_theta_err)
            if not os.path.isfile(filename):
                ...
                if args.poison_whole:
                    filename = 'files/online_models/{}/{}/{}/{}/{}/whole-{}_online_for_real_data_tol-{}_err-{}.npz'.format(dataset_name,args.model_type,args.rand_seed,target_gen_proc,args.repeat_num,subpop_ind,args.incre_tol_par,valid_theta_err)
                else:
                    filename = 'files/online_models/{}/{}/{}/{}/{}/subpop-{}_online_for_real_data_tol-{}_err-{}.npz'.format(dataset_name,args.model_type,args.rand_seed,target_gen_proc,args.repeat_num,subpop_ind,args.incre_tol_par,valid_theta_err)
                np.savez(filename,
                ...
                print('POISONING POINTS: ')
                print(len(online_poisons_y))
                ...
                print()
                print('Accuracy on negative train points : %.3f' % model_p_online.score(X_train[trn_neg_sbcl],y_train[trn_neg_sbcl]))
                print('Accuracy on positive train points : %.3f' % model_p_online.score(X_train[trn_pos_sbcl],y_train[trn_pos_sbcl]))
                print('Accuracy on negative test points : %.3f' % model_p_online.score(X_test[tst_neg_sbcl],y_test[tst_neg_sbcl]))
                print('Accuracy on positive test points : %.3f' % model_p_online.score(X_test[tst_pos_sbcl],y_test[tst_pos_sbcl]))
                print()
                print('Percentage of training points being classified as positive : %.3f' % model_p_online.score(trn_sub_x,flipped_trn_sub_y))
